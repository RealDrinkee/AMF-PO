...
class Funcionario():
    ...
    def aumentarSalario(self, salario):
        totalPorcentagem = int(input("Digite a porcentagem de aumento: "))
        self.__funcionarioDados["salario"] = self.__funcionarioDados["salario"] + (self.__funcionarioDados["salario"] * totalPorcentagem / 100)
        return self.__funcionarioDados["salario"]
        ...
        while True:
            ...
            try:
                if opcao == 1:
                    ...
                    print(f"O salário do funcionário é: {self.aumentarSalario(0)}")
                elif opcao == 5:
                    print("Saindo...")
                    exit()
                else:
